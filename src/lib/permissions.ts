...
export const ROLE_PERMISSIONS: Record<string, RolePermissions> = {
    ...
    'CampusHead': {
        ...
        adminManagement: { access: true, scope: 'view-only', canCreate: false, canEdit: false, canDelete: false },
        campusPerformance: { access: true, scope: 'campus' },
    ...
    'Admission Admin': {
        ...
        userManagement: { access: true, scope: 'view-only', canCreate: false, canEdit: false, canDelete: false },
        studentManagement: { access: true, scope: 'view-only', canCreate: false, canEdit: false, canDelete: false },
        adminManagement: { access: false, scope: 'none' },
        campusPerformance: { access: true, scope: 'view-only' },
