...
export const AuthLayout = ({ children, animationKey }: { children: React.ReactNode, animationKey?: string | number }) => {
    return (
        <main className="h-screen w-full flex bg-[#0f172a] overflow-hidden relative">
            ...
            <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-6 lg:p-12 relative h-full overflow-hidden z-10">

                {/* Glass Container */}
                <div className="relative z-10 w-full max-w-md sm:max-w-lg flex-1 flex flex-col justify-center">
                    <AnimatePresence mode="wait">
                        <motion.div
                            ...
                            className="w-full bg-white/5 backdrop-blur-xl p-8 py-12 rounded-3xl border border-white/10 shadow-2xl shadow-black/20 min-h-[500px] flex flex-col justify-center relative overflow-hidden"
                        >
                            {/* Inner Shine Effect */}
