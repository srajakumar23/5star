...
export default async function AnalyticsDesignPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pb-20">
            ...
            <div className="bg-gradient-to-r from-purple-700 to-violet-700 border-b border-purple-900">
                <div className="px-6 py-8 max-w-5xl mx-auto flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        <Link href="/design/purple-gold" className="w-10 h-10 bg-white/20 hover:bg-white/30 backdrop-blur-sm rounded-lg flex items-center justify-center border border-white/20 transition-all">
                        ...
                        <div>
                            ...
                            <p className="text-purple-100 text-sm font-medium mt-0.5 flex items-center gap-1.5">
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-lg px-3 py-1.5 border border-white/20 flex items-center gap-2">
                        <span className="text-[10px] font-semibold text-purple-100 uppercase tracking-wider">Year</span>
            ...
            <div className="max-w-5xl mx-auto px-6 py-8 space-y-6">
                ...
                <div className="grid md:grid-cols-3 gap-5">
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border-2 border-purple-100 dark:border-purple-900">
                        <div className="flex items-center justify-between mb-5">
                            <div className="w-11 h-11 bg-purple-50 dark:bg-purple-900/30 rounded-lg flex items-center justify-center">
                                <TrendingUp size={20} className="text-purple-600" strokeWidth={2} />
                            </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl p-8 border border-gray-200 dark:border-gray-700 shadow-sm">
                    <div className="flex items-center gap-3 mb-6">
                        <div className="w-1 h-8 bg-gradient-to-b from-purple-600 to-purple-700 rounded-sm" />
                        <div>
                            ...
                            {tiers.map((tier, index) => {
                                ...
                                return (
                                    <div key={tier.count} className={`relative py-5 px-2 rounded-lg text-center border transition-all duration-200 ${getCardClasses()}`}>
                                        <div className={`text-[10px] font-semibold uppercase tracking-wider mb-2 ${isCurrentTier ? 'text-white' : isAchieved ? 'text-purple-600 dark:text-pink-400' : 'text-gray-500 dark:text-gray-400'
                                            }`}>
                    ...
                    <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-6 border border-gray-200 dark:border-gray-700">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            ...
                            <div className="bg-white dark:bg-gray-900 rounded-lg p-5 border border-gray-200 dark:border-gray-700">
                                ...
                                <p className="text-4xl font-semibold text-purple-600 mb-1 tracking-tight">15%</p>
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-purple-100 font-medium">5 Referrals Required</p>
                            </div>
                        </div>
                        <div className="text-right">
                            <p className="text-[10px] font-semibold text-purple-100 uppercase tracking-wider mb-1">Progress</p>
